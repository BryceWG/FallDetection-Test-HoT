#!/usr/bin/env python
# -*- coding: utf-8 -*-
# python train/train_gru.py --label_file fall_frame_data.csv
import os
import sys
import glob
import copy
...
def process_args():
    ...
    处理命令行参数
    """
    parser = argparse.ArgumentParser(description='跌倒检测GRU模型训练')
    ...
    default_save_dir = f'./checkpoint/fall_detection_gru/{timestamp}'
